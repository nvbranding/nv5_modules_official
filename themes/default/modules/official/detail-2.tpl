<!-- BEGIN: main -->
<div id="viewdetail" <!-- BEGIN: isprint1 -->class="isprint"<!-- END: isprint1 -->>
	...
	<div class="panel panel-default">
		<table class="table table-striped table-bordered table-hover">
			<tr>
				<th>{LANG.fullname}</th>
				<td>{DATA.fullname}</td>
				<td colspan="2" rowspan="3" align="center"><img src="{DATA.image}" alt="{DATA.fullname}" class="img-thumbnail pointer" width="90" id="openImageModal" /></td>
			</tr>
			<tr>
				<th>{LANG.part}</th>
